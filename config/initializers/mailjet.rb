...
Mailjet.configure do |config|
  config.api_key = Rails.application.credentials.mailjet[:mailjet_smtp_login]
  config.secret_key = Rails.application.credentials.mailjet[:mailjet_password]
  config.default_from = Rails.application.credentials.mailjet[:mailjet_default_from]
